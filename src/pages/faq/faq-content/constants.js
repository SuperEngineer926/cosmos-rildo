    ...
    questions: [
      {
        ...
        answer: <p>8,887 campers will converge in the form of ERC-721 tokens.</p>,
      },
      {
        question: <h6>How do I get on the Camp List?</h6>,
        answer: <p>Early bird camp registration is still open, there are many opportunities in Discord to get on the Camplist! Pandora will be hand-selecting the best and brightest to join us at Camp Cosmos.</p>,
      },
      {
        question: <h6>Wen mint?</h6>,
        answer: <p>The Cosmic Convergence will occur during Q3 of 2022</p>,
      },
      {
        question: <h6>What is the mint price per Camper?</h6>,
        answer: <p>Cost of entry to camp will be announced prior to mint.</p>,
      },
      {
        question: <h6>What type of contract will you be using?</h6>,
        answer: <p>Pandora has favored the ERC-721A Contract, and her Terrestrial scientists will be reviewing and providing a comprehensive analysis prior to the mint date.</p>,
      },
    ]
  },
  {

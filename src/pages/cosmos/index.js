...
const Cosmos = () => {
  ...
  const [bSafari, setBSafari] = useState('bChrome');
  useEffect(() => {
    if(isSafari) setBSafari('bSafari')
  }, [isSafari])

  // const bSafari = isSafari? 'bSafari' : 'bChrome';
  console.log(isSafari, bSafari)
                    ...
                    <Link href={route}>
                      <a>
                        <div key={`explore--item-${id}`} className={`explore--item explore--item-${index}`}>
                          ...
                          {console.log(bSafari)}
                          <div className={'explore--details ' + bSafari}>
                            <div>

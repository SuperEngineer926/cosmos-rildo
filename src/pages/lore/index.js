...
import backgroundImage from '../../../public/images/pages-background/lorebackground.png';
      ...
      <div>
        <div className="lore--content page-layout">
          ...
          <div className="lore--content-summary">
            <p>Camp Cosmos is a haven for the creatively gifted, altruistic, and philosophically curious of the universe, located on Planet Earth in the Milky Way Galaxy. Upon arrival, you’ll be joined by 8,887 other campers from across the cosmos who are eager to share all of the transcendental knowledge the universe has offered them, as well as stellar art and some pretty great music too.</p>
